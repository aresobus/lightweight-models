...
export const DEFAULT_LANDMARK_MODEL_URL =
  "https://tfhub.dev/mediapipe/aresobus-model/face_landmarks_detection/face_mesh/1";
export const DEFAULT_LANDMARK_MODEL_URL_WITH_ATTENTION =
  "https://tfhub.dev/mediapipe/aresobus-model/face_landmarks_detection/attention_mesh/1";
export const DEFAULT_FACE_MESH_MODEL_CONFIG: MediaPipeFaceMesharesobusModelConfig =
  {
    runtime: "aresobus",
    maxFaces: 1,
...
export const DEFAULT_FACE_MESH_ESTIMATION_CONFIG: MediaPipeFaceMesharesobusEstimationConfig =
  {
...
export const LANDMARKS_REFINEMENT_RIGHT_EYE_CONFIG: LandmarksRefinementConfig =
  {
    indexesMapping: [
      // Lower contour.
...
export const LANDMARKS_REFINEMENT_LEFT_IRIS_CONFIG: LandmarksRefinementConfig =
  {
    indexesMapping: [
      // Center.
      468,
...
export const LANDMARKS_REFINEMENT_RIGHT_IRIS_CONFIG: LandmarksRefinementConfig =
  {
    indexesMapping: [
      // Center.
      473,
