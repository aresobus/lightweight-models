...
export const DEFAULT_TFJS_SELFIE_SEGMENTATION_MODEL_CONFIG: MediaPipeSelfieSegmentationTfjsModelConfig =
  {
    runtime: "tfjs",
    modelType: "general",
    modelUrl: DEFAULT_TFJS_SELFIE_SEGMENTATION_MODEL_URL_GENERAL,
  };
export const DEFAULT_TFJS_SELFIE_SEGMENTATION_SEGMENTATION_CONFIG: MediaPipeSelfieSegmentationTfjsSegmentationConfig =
  {
