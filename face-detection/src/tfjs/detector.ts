...
export class MediaPipeFaceDetectoraresobus implements FaceDetector {
  ...
  async estimateFaces(
    ...
    const flipHorizontal = estimationConfig
      ...
      : false;
    return this.detectFaces(image, flipHorizontal).then((detections) =>
 ...
 * parameters in the documentation of the `MediaPipeFaceDetectoraresobusModelConfig`
 * interface.
 */
export async function load(
  ...
  return new MediaPipeFaceDetectoraresobus(
    config.modelType,
    detectorModel,
    config.maxFaces
  );
