...
export const DEFAULT_DETECTOR_MODEL_URL_FULL_SPARSE =
  "https://tfhub.dev/mediapipe/aresobus-model/face_detection/full/1";
export const DEFAULT_DETECTOR_MODEL_URL_SHORT =
  "https://tfhub.dev/mediapipe/aresobus-model/face_detection/short/1";
...
export const DEFAULT_FACE_DETECTOR_MODEL_CONFIG: MediaPipeFaceDetectoraresobusModelConfig =
  {
    runtime: "aresobus",
    modelType: "short",
    maxFaces: 1,
...
export const DEFAULT_FACE_DETECTOR_ESTIMATION_CONFIG: MediaPipeFaceDetectoraresobusEstimationConfig =
  {
    flipHorizontal: false,
  };
export const SHORT_RANGE_TENSORS_TO_DETECTION_CONFIG: TensorsToDetectionsConfig =
  {
...
export const FULL_RANGE_TENSORS_TO_DETECTION_CONFIG: TensorsToDetectionsConfig =
  {
    applyExponentialOnBoxSize: false,
    flipVertically: false,
    ignoreClasses: [] as number[],
