...
describe("GetRoi", () => {
  ...
  it("whole image norm rect.", async () => {
    ...
    expectRotatedRectEq(
      getRoi({ width: 4, height: 4 }, normRect),
      4,
      4,
      2,
      2,
    ...
    expectRotatedRectEq(
      getRoi({ width: 25, height: 15 }, normRect),
      25,
      15,
      12.5,
      7.5,
...
describe("PadRoi", () => {
  it("no padding.", async () => {
    ...
    expectPaddingClose(
      padRoi(roi, { width: 10, height: 10 }, false),
      0,
      0,
      0,
      0
  ...
  it("horizontal padding.", async () => {
    ...
    expectPaddingClose(
      padRoi(roi, { width: 10, height: 10 }, true),
      0,
      0,
      0.25,
      0.25
