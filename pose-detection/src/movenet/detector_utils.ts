...
import {
  ...
  DEFAULT_KEYPOINT_TRACKER_CONFIG,
  MOVENET_CONFIG,
...
export function validateModelConfig(
  ...
  if (
    config.multiPoseMaxDimension != null &&
  ...
  if (
    config.modelType === MULTIPOSE_LIGHTNING &&
...
export function validateEstimationConfig(
  estimationConfig: MoveNetEstimationConfig
...
export function mergeKeypointTrackerConfig(
  ...
  const mergedConfig = mergeBaseTrackerConfig(
    DEFAULT_KEYPOINT_TRACKER_CONFIG,
    userConfig
  );
