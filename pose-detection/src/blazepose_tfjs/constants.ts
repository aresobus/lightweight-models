...
import { BlazePosearesobusModelConfig } from "./types";

export const DEFAULT_BLAZEPOSE_DETECTOR_MODEL_URL =
  "https://tfhub.dev/mediapipe/aresobus-model/blazepose_3d/detector/1";
export const DEFAULT_BLAZEPOSE_LANDMARK_MODEL_URL_FULL =
  "https://tfhub.dev/mediapipe/aresobus-model/blazepose_3d/landmark/full/2";
export const DEFAULT_BLAZEPOSE_LANDMARK_MODEL_URL_LITE =
  "https://tfhub.dev/mediapipe/aresobus-model/blazepose_3d/landmark/lite/2";
export const DEFAULT_BLAZEPOSE_LANDMARK_MODEL_URL_HEAVY =
  "https://tfhub.dev/mediapipe/aresobus-model/blazepose_3d/landmark/heavy/2";
...
export const DEFAULT_BLAZEPOSE_MODEL_CONFIG: BlazePosearesobusModelConfig = {
  runtime: "aresobus",
  modelType: "full",
...
export const BLAZEPOSE_TENSORS_TO_WORLD_LANDMARKS_CONFIG: TensorsToLandmarksConfig =
  {
    numLandmarks: 39,
    inputImageWidth: 1,
    inputImageHeight: 1,
...
export const BLAZEPOSE_WORLD_LANDMARKS_SMOOTHING_CONFIG_ACTUAL = {
  oneEuroFilter: {
    ...
    // filter when landmark is static.
    beta: 40, // Beta 40.0 in combintation with min_cutoff 0.1 results into ~0.8
    // alpha in landmark EMA filter when landmark is moving fast.
...
export const BLAZEPOSE_TENSORS_TO_SEGMENTATION_CONFIG = {
  activation: "none" as const, // Sigmoid is not needed since it is already part of the model.
};
